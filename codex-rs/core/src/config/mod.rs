...
pub struct Config {
    ...
    /// Whether Docker MCP Toolkit auto-configuration has been accepted or declined.
...
impl Config {
    ...
    pub(crate) async fn load_config_with_layer_stack(
        ...
        let model_provider_id = model_provider
            ...
            .unwrap_or_else(|| DOCKER_MODEL_RUNNER_PROVIDER_ID.to_string());
        ...
        let model = model
            .or(cfg.model)
            .unwrap_or_else(|| DOCKER_MODEL_RUNNER_DEFAULT_MODEL.to_string());
        ...
        let config = Self {
            ...
            model_provider_id,
            model_provider,
            docker_mcp_auto_configure: cfg.docker_mcp_auto_configure,
            cwd: resolved_cwd,
